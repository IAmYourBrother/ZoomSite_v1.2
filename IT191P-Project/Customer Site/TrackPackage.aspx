...
<asp:Content ID="Content2" ContentPlaceHolderID="main_content" runat="server">
    ...
    <div class="col-lg-12">
        <asp:GridView ID="gvCheckPackage" runat="server" AutoGenerateColumns="False" DataSourceID="CheckPackageSqlDataSource">
            <Columns>
        ...
        <asp:SqlDataSource ID="CheckPackageSqlDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:ZoomDB %>" 
            SelectCommand="SELECT ID, TRANSACTION_ID, TRACKING_NO, SOURCE_BRANCH_ID, DESTINATION_BRANCH_ID, STATUS, PAYMENT FROM [TRANSACTION] WHERE CUSTOMER_ID = @id AND TYPE = 'Package'">
            <SelectParameters>
